...
<head>
    ...
    <title>Locais Mais Visitados - Norte</title>
    <style>
...
<nav id="navbar">
    ...
    <section id="ranking">
        <div class="container">
            <h2>Ranking dos Locais Mais Visitados - Norte</h2>
            ...
            <?php
                    ...
                    $sql = "SELECT name, lat, lng, visits, foto, regiao, descricao FROM places WHERE regiao = 'norte' ORDER BY visits DESC LIMIT 3";
